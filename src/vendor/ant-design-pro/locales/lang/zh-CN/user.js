export default {
  ...
  'user.login.gitee-login-credentials': 'gitee账号登录',
  ...
  'user.login.login': '登录',
  'user.login.gitee-login': '使用gitee账号登录',
  'user.register.register': '注册',
  'user.register.email.placeholder': '邮箱',
  'user.register.username.placeholder': '用户名',
  'user.register.message-invalid-credentials': '注册格式不正确',
  'user.register.password.placeholder': '请输入6-20个字符。请不要使用容易被猜到的密码。',
  'user.register.repassword.placeholder': '再次输入密码以确认。',
